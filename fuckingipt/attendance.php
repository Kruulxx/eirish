...
$con=mysqli_connect('localhost','root','','eirish_db');
...
<body>
 ...
 <div class="border-bottom my-3"></div> 
            ...
            <a href="javascript:void(0);" class="btn btn-dark" onclick="formToggle('importFrm');"><i class="plus"></i> Import File</a>
